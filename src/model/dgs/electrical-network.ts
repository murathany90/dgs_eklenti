...
export function mapElectricalNetwork(document: DgsDocument, modelId: string, modelHash: string): ElectricalCanonicalNetwork {
  ...
  return { modelId, modelHash, scope: 'FULL', completeness: incomplete ? 'PARTIAL' : 'COMPLETE', buses, lines, transformers, generators, loads, shunts, seriesCompensators, externalGrids, switches, controls, loadFlowSettings,
