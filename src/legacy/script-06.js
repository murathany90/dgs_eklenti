...
(function(){
 ...
 const origRenderLightning=v42RenderLightning;v42RenderLightning=function(){origRenderLightning();if(window.YTBS_ActiveMapResult)return;const root=$('v42LBody');if(!active||!v42.opened||!root)return;
