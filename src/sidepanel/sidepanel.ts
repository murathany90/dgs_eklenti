...
declare const chrome: { runtime: { getURL: (path: string) => string }; tabs: { create: (options: { url: string }) => Promise<unknown> } };
...
document.querySelector<HTMLButtonElement>('#openWorkspace')!.addEventListener('click', () => {
