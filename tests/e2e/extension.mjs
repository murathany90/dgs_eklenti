...
try {
  ...
  if (await page.title() !== 'Grid Analyzer | Şebeke Analiz Sistemi v6.1.6') throw Error(`Workspace title branding mismatch: ${await page.title()}`);
  ...
  if (!(await page.locator('#footerRight').innerText()).includes('Grid Analyzer · Chrome MV3 · v6.1.6')) throw Error('Workspace footer branding missing');
  ...
  if (manifest.manifest_version !== 3 || manifest.version !== '6.1.6' || manifest.name !== 'Grid Analyzer - Şebeke Analiz Sistemi' || manifest.icons?.['16'] !== 'assets/icons/ga-16.png') throw Error('Manifest V3 / v6.1.6 branding mismatch');
